...
go_repository(
    ...
    build_directives = [
        ...
        #"gazelle:resolve go google.golang.org/genproto/googleapis/api/httpbody @org_golang_google_genproto//googleapis/api/httpbody",
    ],
...
go_repository(
    ...
    build_directives = [
        ...
        "gazelle:resolve go google.golang.org/genproto/googleapis/api/annotations @org_golang_google_genproto_googleapis_api//annotations",  # keep
    ],
    build_file_proto_mode = "disable_global",
